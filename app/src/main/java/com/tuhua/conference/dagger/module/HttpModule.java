...
import com.tuhua.conference.dagger.qualifiter.EntUrl;
import com.tuhua.conference.http.CookieHolder;
import com.tuhua.conference.http.EntApi;
import com.tuhua.conference.http.HttpCacheInterceptor;
import com.tuhua.conference.http.HttpConfig;
import com.tuhua.conference.http.ParamsInterceptor;
...
public class HttpModule {
    ...
    OkHttpClient provideClient(OkHttpClient.Builder builder) {
        ...
        if (BuildConfig.DEBUG) {
            builder.addNetworkInterceptor(new StethoInterceptor());//TODO stetho网络请求拦截器，用于调试
        }
